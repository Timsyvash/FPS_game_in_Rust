...
pub fn update_player(
    ...
    spawn_spot: Query<&GlobalTransform,With<TracerSpawnShot>>
) {
    ...
    if let Ok((_player, _transform)) = player_query.get_single_mut(){
        if mouse_input.just_pressed(MouseButton::Left) {
            ...
            if let Some((entity, ray_intersection)) = hit {
                ...
                let tracker_material = StandardMaterial {
                ...
                commands.spawn((
                    PbrBundle {
                        ...
                        material: materials.add(tracker_material),
                        ..default()
                    },
